...
public class RpcConsumerNativeTest {
    ...
    public static void main(String[] args){
        RpcClient rpcClient = new RpcClient("jdk","127.0.0.1:2181", "zookeeper", "1.0.0", "binghe", "jdk", 3000, false, false);
    ...
    public void initRpcClient(){
        rpcClient = new RpcClient("jdk","127.0.0.1:2181", "zookeeper", "1.0.0", "binghe", "json", 3000, false, false);
